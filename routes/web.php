...
Route::get('html-parser', [PdfController::class, 'htmlParser'])->name('html-parser');
Route::get('upload-merge', [PdfController::class, 'uploadMerge'])->name('upload-merge');
Route::get('pdf-qr', [PdfController::class, 'pdfQr'])->name('pdf.qr');
...
Route::post('proses-pdf-qr', [PdfController::class, 'prosesPdfQr'])->name('proses-pdf-qr');
